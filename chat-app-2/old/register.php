        ...
        <form action="" method="POST">
            <section aria-label="register">
                <div class="card card-login shadow rounded">
                    <div class="card-body">
                        <h3 class="card-title mb-3">Register to Create Your Account</h2>
                            <!-- svg -->
                            ...
                            <div class="row">
                                ...
                                <h6 class="text-center mt-2 mb-0">Or</h6>
                                <div class="col-12 mb-3">
                                    <label for="phone-number" class="form-label">Phone Number</label>
                                    <input type="num" class="form-control" id="phone-number" name="phone-number"
                            ...
                            <hr>
                            <section id="links">
                                <p>Already Have an Account? Click <a
                                        href="http://localhost:82/chat-app-2/login.php">Here</a> To Login</p>
                            </section>
                    </div>
                </div>
            </section>
